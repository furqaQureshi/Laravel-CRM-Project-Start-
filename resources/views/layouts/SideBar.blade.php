                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/pages/student/student_create.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Student</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/pages/student/manage_student.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Manage Student</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/pages/class/create_class.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Class</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/pages/class/manage_class.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Manage Class</p>
                                    </a>
                                </li>
